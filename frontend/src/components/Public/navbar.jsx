...
import { FaSearch, FaCalendarAlt, FaComments, FaUser, FaSignOutAlt, FaHome, FaBars, FaTimes } from "react-icons/fa";
import { Link, useNavigate } from "react-router-dom";
import { jwtDecode } from "jwt-decode";
import "../../css/navbar.css";
import logo from "../../assets/logo_edited.png";
  ...
  return (
    <nav className="navbar" ref={navRef}>
      ...
      <div className={`navbar-right ${menuOpen ? 'active' : ''}`}>
        ...
        {/* Conditional Appointment Redirect based on role */}
        {role === "counsellor" ? (
          <Link to="/counselor/dashboard" className="nav-link" onClick={() => setMenuOpen(false)}>
        ...
        <a onClick={() => {handleLogout(); setMenuOpen(false);}} className="nav-link">
          <FaSignOutAlt /> <span>Logout</span>
        </a>
        
        {/* Search Bar in Mobile Menu (visible when menu is open on small screens) */}
